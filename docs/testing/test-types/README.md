...
In the LocalEmu codebase we differentiate between the following test types:
...
- It shows some kind of real-world usage. This is usually a scenario or architectural pattern with multiple services.
    ...
    - Existing samples (from [our samples organization](https://github.com/localemu-samples)) might serve as a starting point for constructing such a scenario.

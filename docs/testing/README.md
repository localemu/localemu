...
Through experience, we encountered some guiding principles and rules when it comes to testing LocalEmu.
...
in: [localemu/testing/pytest/marking.py](../../src/localemu/testing/pytest/marking.py)

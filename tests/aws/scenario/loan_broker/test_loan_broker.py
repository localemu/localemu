"""
This scenario test is taken from https://github.com/localemu-samples/sample-loan-broker-stepfunctions-lambda
...
from localemu.testing.pytest.stepfunctions.utils import await_execution_terminated

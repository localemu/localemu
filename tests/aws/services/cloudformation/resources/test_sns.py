...
from localemu.aws.api.cloudformation import Stack
...
def test_sns_topic_update_attributes(deploy_cfn_template, aws_client, snapshot):
    ...
    assert tag_dict["Project"] == "localemu"
...
def test_sns_topic_update_name(deploy_cfn_template, aws_client, snapshot):
    ...
    assert initial_tag_dict["Project"] == "localemu"
    ...
    assert new_tag_dict["Project"] == initial_tag_dict["Project"]  # Should be "localemu"

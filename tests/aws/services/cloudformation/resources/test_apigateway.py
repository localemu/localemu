...
# this is an `only_localemu` test because it makes use of _custom_id_ tag
...
def test_cfn_apigateway_aws_integration(deploy_cfn_template, aws_client):
    ...
    expected_domain = "cfn5632.localemu.cloud"  # hardcoded value from template yaml file
...
class TestServerlessApigwLambda:
    ...
    def test_serverless_like_deployment_stage_survives_update(
        ...
        """
        Regression test for https://github.com/localemu/localemu/issues/13667
...
class TestApiGatewayBasePathMapping:
    ...
    def test_delete_base_path_mapping_missing_base_path(
        ...
        Note: this test is `only_localemu` because it requires a valid ACM certificate
        ...
        domain_name = f"api-{short_uid()}.localhost"

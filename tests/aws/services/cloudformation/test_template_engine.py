...
from localemu.testing.aws.cloudformation_utils import load_template_file, load_template_raw
...
from localemu.utils.sync import wait_until
...
class TestSsmParameters:
    ...
    def test_ssm_nested_with_nested_stack(self, s3_create_bucket, deploy_cfn_template, aws_client):
        ...
        domain = "amazonaws.com" if is_aws_cloud() else "localhost:4566"

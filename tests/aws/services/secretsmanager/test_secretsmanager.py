...
from localemu.testing.config import TEST_AWS_ACCESS_KEY_ID, TEST_AWS_REGION_NAME
...
class TestSecretsManager:
    ...
    @markers.aws.only_localemu  # FIXME: all tests using the internal http utils of this class are only targeting localemu
...
class TestSecretsManagerMultiAccounts:
    ...
    def test_cross_account_access(self, aws_client, secondary_aws_client, cleanups):
        ...
        # but it will be None in Localemu. To avoid failing the test, we will use the default value as list

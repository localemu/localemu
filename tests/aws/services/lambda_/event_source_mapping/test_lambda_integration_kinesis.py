...
from localemu.services.lambda_.event_source_mapping.pollers.kinesis_poller import (
    KinesisPoller,
)
...
from localemu.utils.aws.arns import s3_bucket_arn
from localemu.utils.strings import short_uid, to_bytes
from localemu.utils.sync import ShortCircuitWaitException, retry, wait_until
...
class TestKinesisSource:
    ...
    def test_kinesis_maximum_record_age_exceeded(
        ...
        if not is_aws_cloud():
            # LocalEmu test optimization: Override MaximumRecordAgeInSeconds directly
...
class TestKinesisEventFiltering:
    ...
    def test_kinesis_event_filtering_json_pattern(
        ...
        # TODO: missing trailing \n is a LocalEmu Lambda logging issue

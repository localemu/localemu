...
from localemu.services.lambda_.invocation.lambda_models import S3Code
...
class TestLambdaUnzipCrash:
    ...
    def test_unzip_crash_leaves_no_corrupted_files(
        ...
        """
        Integration test to test fix for issue https://github.com/localemu/localemu/issues/13555
        ...
        with patch(
            "localemu.services.lambda_.invocation.lambda_models.unzip", side_effect=crashing_unzip
        ):

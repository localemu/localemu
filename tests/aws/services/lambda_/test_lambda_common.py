...
from localemu.services.lambda_.runtimes import RUNTIMES_AGGREGATED, TESTED_RUNTIMES
from localemu.testing.pytest import markers
from localemu.utils.files import cp_r
...
def snapshot_transformers(snapshot):
    ...
    snapshot.add_transformers_list(
        [
            ...
            # Works in LocalEmu locally but the hash changes in CI and every time at AWS (except for Java runtimes)
...
@markers.lambda_runtime_update
class TestLambdaCallingLocalemu:

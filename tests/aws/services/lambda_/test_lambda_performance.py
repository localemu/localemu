...
from localemu.aws.api.lambda_ import InvocationType, Runtime
...
from localemu.utils.strings import short_uid, to_bytes
...
def test_number_of_function_versions_sync(create_lambda_function, s3_bucket, aws_client):
    """Test how many function versions LocalEmu can support; validating **synchronous** invokes."""
...
def test_number_of_function_versions_async(create_lambda_function, s3_bucket, aws_client):
    """Test how many function versions LocalEmu can support; validating **asynchronous** invokes."""
    num_function_versions = 2 if is_aws_cloud() else 100
...
def test_number_of_functions_sync(
    ...
    """Test how many active functions LocalEmu can support; validating **synchronous** invokes."""
...
def test_number_of_functions_async(
    ...
    """Test how many active functions LocalEmu can support; validating **asynchronous** invokes."""

...
from localemu.constants import AWS_REGION_US_EAST_1, TAG_KEY_CUSTOM_ID
from localemu.services.ec2.patches import SecurityGroupIdentifier, VpcIdentifier
from localemu.testing.aws.util import is_aws_cloud
from localemu.testing.pytest import markers
from localemu.utils.id_generator import localemu_id_manager
...
class TestEc2Integrations:
    ...
    # TODO LocalEmu fails to delete endpoints
    #  LocalEmu does not properly initiate Endpoints with no VpcEndpointType fix probably needed in moto
    ...
    def test_vpc_endpoint_dns_names(
        ...
        host = "amazonaws.com" if is_aws_cloud() else localemu_host().host_and_port()
    ...
    def test_create_security_group_with_custom_id(
        ...
        def _create_security_group() -> dict:
            ...
            if strategy == "tag":
                ...
                with localemu_id_manager.custom_id(
    ...
    @markers.snapshot.skip_snapshot_verify(
        paths=[
            ...
            "$..Vpc.DhcpOptionsId",  # FIXME: DhcpOptionsId uses different reference formats in AWS vs LocalEmu

...
from localemu.aws.api.iam import Tag
from localemu.services.iam.iam_patches import ADDITIONAL_MANAGED_POLICIES
from localemu.testing.aws.util import create_client_with_keys, wait_for_user
...
class TestIAMExtensions:
    ...
    def test_get_user_without_username_as_root(self, aws_client):
        """Test get_user on root account. Marked only localemu, since we usually cannot access as root directly"""
        account_id = aws_client.sts.get_caller_identity()["Account"]

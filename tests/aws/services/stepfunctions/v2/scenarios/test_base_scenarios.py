...
import pytest
from localemu.testing.snapshots.transformer import JsonpathTransformer, RegexTransformer
...
from localemu.testing.pytest.stepfunctions.utils import (
...
class TestBaseScenarios:
    ...
    @markers.snapshot.skip_snapshot_verify(
        paths=[
            ...
            # LocalEmu currently has this previous state as MapRunSucceeded.
        ...
        [
            ...
            pytest.param(
                ...
                marks=pytest.mark.skipif(
                    ...
                    reason="LocalEmu does not correctly handle when a higher-order function is passed as a parameter.",
                ),
            ),
        ],

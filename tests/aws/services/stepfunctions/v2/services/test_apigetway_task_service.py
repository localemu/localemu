...
import pytest
from localemu.testing.snapshots.transformer import JsonpathTransformer
...
from localemu.utils.aws import arns, aws_stack
...
@markers.snapshot.skip_snapshot_verify(
    paths=[
        ...
        #  localemu.services.stepfunctions.asl.component.state.state_execution.state_task.service.state_task_service_api_gateway.StateTaskServiceApiGateway._invoke_output_of

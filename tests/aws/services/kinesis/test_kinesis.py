...
from localemu.aws.protocol._cbor import dumps as cbor2_dumps
...
from localemu.aws.client import _patch_cbor2
from localemu.services.kinesis import provider as kinesis_provider
from localemu.testing.aws.util import is_aws_cloud
from localemu.testing.pytest import markers
from localemu.utils.aws import resources
from localemu.utils.aws.arns import kinesis_stream_arn
from localemu.utils.common import retry, select_attributes, short_uid
...
# (for the test-data decoding, usually done as init hook in LocalEmu)
_patch_cbor2()
...
class TestKinesis:
    ...
    def test_resource_policy_crud(
        ...
        # on localemu and AWS, as the later triggers end-point-resolution in botocore
    ...
    def test_subscribe_to_shard_with_at_timestamp_cbor(
        ...
        # perform a raw DescribeStream request to test the datetime serialization by LocalEmu

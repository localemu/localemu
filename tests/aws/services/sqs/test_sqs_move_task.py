...
from localemu.services.sqs.utils import decode_move_task_handle, encode_move_task_handle
...
@pytest.mark.skip_snapshot_verify(
    paths=[
        # this is non-deterministic because of concurrency in AWS vs LocalEmu

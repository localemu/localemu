...
from localemu.aws.api.transcribe import BadRequestException, ConflictException, NotFoundException
...
from localemu.services.transcribe.provider import LANGUAGE_MODELS, TranscribeProvider
...
class TestTranscribe:
    ...
    def pre_install_dependencies(self):
        if is_aws_cloud() or test_config.TEST_SKIP_LOCALEMU_START:
            # we don't install the dependencies if LocalEmu is not running in process
            return

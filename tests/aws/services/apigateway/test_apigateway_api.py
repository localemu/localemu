...
from localemu.aws.api.apigateway import PutMode
...
class TestApigatewayIntegrationResponse:
    ...
    @markers.aws.validated
    @pytest.mark.skipif(
        condition=not is_aws_cloud(), reason="Validation not yet implemented in LocalEmu"
    )
    def test_integration_response_invalid_responsetemplates(
        ...
        #   But LocalEmu currently doesn't raise any Error

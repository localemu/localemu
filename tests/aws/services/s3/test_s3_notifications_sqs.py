...
class TestS3NotificationsToSQS:
    ...
    def test_key_encoding(
        ...
        # test for https://github.com/localemu/localemu/issues/2741
    ...
    def test_xray_header(
        ...
        # test for https://github.com/localemu/localemu/issues/3686
        ...
        aws_client.s3.put_bucket_notification_configuration(
            ...
            NotificationConfiguration={
                "QueueConfigurations": [
                    ...
                    {
                        # Add second config to test fix https://github.com/localemu/localemu/issues/450
                        "Id": "id0002",
                        "QueueArn": queue_arn,

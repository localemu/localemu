...
from localemu.aws.handlers.validation import OpenAPIRequestValidator
...
class TestOpenAPIRequestValidator:
    ...
    def test_path_not_found(self):
        ...
        context = RequestContext(
            Request(
                path="/_localemu/not_existing_endpoint",
                method="GET",
                scheme="http",
                headers={"Host": "localhost:4566"},
            )
    ...
    def test_multiple_specs(self, openapi):
        ...
        context = RequestContext(
            Request(
                path="/_localemu/dummy/dummyName",
                method="GET",
                scheme="http",
                headers={"Host": "localhost:4566"},
            )

...
from localemu.aws.protocol._cbor import loads as cbor2_loads
...
from localemu.aws.api import CommonServiceException, ServiceException
from localemu.aws.api.dynamodb import (
    AttributeValue,
    CancellationReason,
    TransactionCanceledException,
)
from localemu.aws.api.kinesis import GetRecordsOutput, Record
from localemu.aws.api.lambda_ import ResourceNotFoundException
from localemu.aws.api.route53 import NoSuchHostedZone
from localemu.aws.api.sns import VerificationException
from localemu.aws.api.sqs import (
    InvalidMessageContents,
    ReceiptHandleIsInvalid,
    UnsupportedOperation,
)
from localemu.aws.api.sts import Credentials, GetSessionTokenResponse
from localemu.aws.protocol.serializer import (
...
from localemu.constants import APPLICATION_AMZ_CBOR_1_1, APPLICATION_CBOR
from localemu.http import Request, Response
from localemu.utils.common import to_str
...
def test_rest_xml_serializer_route53_with_botocore():
    parameters = {
        ...
        "DelegationSet": {"NameServers": ["dns.localhost"]},
    }
    _botocore_serializer_integration_test(
...
def test_rpc_v2_cbor_serializer_arc_region_switch_with_botocore():
    # we are using a service that LocalEmu does not implement yet because it implements `smithy-rpc-v2-cbor`
...
class TestAwsResponseSerializerDecorator:
    ...
    def test_query_valid_response(self):
        @aws_response_serializer("sqs-query", "ListQueues")
        def fn(request: Request):
            from localemu.aws.api.sqs import ListQueuesResult

...
from localemu.aws.protocol.parser import (
    CBORRequestParser,
...
from localemu.http import Request as HttpRequest
from localemu.utils.common import to_bytes, to_str
...
def test_sqs_query_parse_tag_map_with_member_name_as_location():
    # see https://github.com/localemu/localemu/issues/4391
    ...
    # https://github.com/localemu/localemu/issues/4391
    request = HttpRequest(
        "POST",
        "/",
        body="Action=TagQueue&"
...
def test_sqs_query_parse_map_with_nested_dict():
    # see https://github.com/localemu/localemu/issues/10949
    parser = create_parser(load_service("sqs-query"))
...
def test_s3_list_buckets_with_localhost():
    # this is the canonical request of `awsemu s3 ls` when running on a standard port
...
def test_s3_list_buckets_with_localhost_and_port():
    # this is the canonical request of `awsemu s3 ls`

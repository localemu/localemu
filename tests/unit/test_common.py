...
from localemu.utils.objects import Mock
from localemu.utils.strings import base64_decode, to_bytes
...
class TestCommon:
    ...
    def test_fully_qualified_class_name(self):
        assert fully_qualified_class_name(Mock) == "localemu.utils.objects.Mock"

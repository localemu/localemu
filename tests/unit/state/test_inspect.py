...
from localemu.services.sqs import models as sqs_models
from localemu.state.inspect import ReflectionStateLocator, ServiceBackendCollectorVisitor
...
class TestReflectionStateLocator:
    def test_collect_store(self, sample_stores, monkeypatch):
        ...
        store_backend = backends.get("localemu")

...
from localemu.services.cloudformation.engine.entities import StackIdentifier
...
def unset_configured_custom_id(default_resource_identifier):
    def _unset(resource_identifier: ResourceIdentifier = None):
        localemu_id_manager.unset_custom_id(resource_identifier or default_resource_identifier)
...
def test_generate_from_unique_identifier_string(
    ...
    localemu_id_manager.set_custom_id_by_unique_identifier(unique_identifier_string, custom_id)
...
def test_custom_id_context_manager(default_resource_identifier):
    custom_id = "set_id"
    with localemu_id_manager.custom_id(default_resource_identifier, custom_id):

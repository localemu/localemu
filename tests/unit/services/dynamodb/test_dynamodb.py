...
from localemu.services.dynamodb.provider import DynamoDBProvider, get_store
...
from localemu.utils.aws.arns import dynamodb_table_arn
...
@patch("localemu.services.dynamodb.utils.SchemaExtractor.get_table_schema")

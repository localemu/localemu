...
from localemu.aws.api.sns import InvalidParameterException
from localemu.services.sns.filter import FilterPolicyValidator, SubscriptionFilter
from localemu.services.sns.models import SnsMessage
from localemu.services.sns.provider import (
...
class TestSns:
    ...
    def test_create_sns_message_body(self, subscriber):
        ...
        expected_sns_body = {
            "Message": "msg",
            "SignatureVersion": "1",
            "SigningCertURL": "http://localhost:4566/_aws/sns/SimpleNotificationService-6c6f63616c737461636b69736e696365.pem",
            "TopicArn": "arn",
            "Type": "Notification",

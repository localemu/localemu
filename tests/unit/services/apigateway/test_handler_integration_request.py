...
from localemu.aws.api.apigateway import Integration, IntegrationType
...
from localemu.services.apigateway.next_gen.execute_api.handlers import (
    IntegrationRequestHandler,
    InvocationRequestParser,
)
from localemu.services.apigateway.next_gen.execute_api.handlers.integration_request import (
    PassthroughBehavior,
)

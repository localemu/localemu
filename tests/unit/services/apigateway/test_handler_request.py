...
from localemu.services.apigateway.models import RestApiContainer
...
from localemu.services.apigateway.next_gen.execute_api.handlers.parse import (
    InvocationRequestParser,
)
from localemu.services.apigateway.next_gen.execute_api.handlers.resource_router import (
    InvocationRequestRouter,
)
from localemu.services.apigateway.next_gen.execute_api.helpers import (
    freeze_rest_api,
    parse_trace_id,
)
from localemu.services.apigateway.next_gen.execute_api.moto_helpers import get_stage_configuration
...
def dummy_deployment():
    ...
    yield freeze_rest_api(
        ...
        localemu_rest_api=RestApiContainer(rest_api={}),
    )
...
class TestParsingHandler:
    ...
    def test_parse_localemu_only_path(
        self, dummy_deployment, parse_handler_chain, get_invocation_context
    ):
        # simulate a path request
        request = Request(
...
class TestRoutingHandler:
    ...
    def deployment_with_routes(self, dummy_deployment):
        ...
        return freeze_rest_api(
            ...
            moto_rest_api=moto_rest_api,
            localemu_rest_api=dummy_deployment.rest_api,
        )

...
from localemu.utils.bootstrap import Container, RunningContainer, get_docker_image_to_start
...
"""Environment variable used to indicate that we should mount LocalEmu source files into the container."""
...
def stream_container_logs() -> Generator[LogStreamFactory, None, None]:
    ...
    ``containers.<container-name>``. You can find it in the logs as::
        ...
        2023-09-03T18:49:06.236 DEBUG --- [log-stream-1] container.localemu-5a4c3678 : foobar
        2023-09-03T18:49:06.236 DEBUG --- [log-stream-1] container.localemu-5a4c3678 : hello world

"""
USAGE: python -m localemu.testing.testselection.scripts.generate_test_selection <repo_root_path> <output_file_path> \
...
from localemu.testing.testselection.git import (
    find_merge_base,
    get_branch_name,
    get_changed_files_from_git_diff,
)
from localemu.testing.testselection.github import (
    get_pr_details_from_branch,
    get_pr_details_from_url,
)
from localemu.testing.testselection.matching import MatchingRule
from localemu.testing.testselection.opt_out import opted_out

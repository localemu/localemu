...
from localemu.utils.patch import Patch, Patches
...
class TracingHandlerChain(HandlerChain):
    ...
    def _call_finalizers(self, response):
        ...
        try:
            # CRIT-01: previously called super()._call_response_handlers which
            # re-ran the response handlers a second time and skipped the real
            # finalizers. Delegate to the actual finalizer hook.
            return super()._call_finalizers(response)
        finally:

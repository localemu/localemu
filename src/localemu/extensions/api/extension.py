...
class BaseExtension(Plugin):
    ...
    def on_extension_load(self, *args, **kwargs):
        """
        Called when LocalEmu loads the extension.
        """
...
class Extension(BaseExtension):
    """
    An extension that is loaded into LocalEmu dynamically.
    ...
    def on_platform_start(self):
        """
        Called when LocalEmu starts the main runtime.
        """
        pass

    def update_gateway_routes(self, router: Router[RouteHandler]):
        """
        Called with the Router attached to the LocalEmu gateway. Overwrite this to add or update routes.
    ...
    def update_request_handlers(self, handlers: CompositeHandler):
        """
        Called with the custom request handlers of the LocalEmu gateway. Overwrite this to add or update handlers.
    ...
    def update_response_handlers(self, handlers: CompositeResponseHandler):
        """
        Called with the custom response handlers of the LocalEmu gateway. Overwrite this to add or update handlers.
    ...
    def update_exception_handlers(self, handlers: CompositeExceptionHandler):
        """
        Called with the custom exception handlers of the LocalEmu gateway. Overwrite this to add or update handlers.
    ...
    def update_finalizers(self, handlers: CompositeFinalizer):
        """
        Called with the custom finalizer handlers of the LocalEmu gateway. Overwrite this to add or update handlers.
    ...
    def on_platform_ready(self):
        """
        Called when LocalEmu is ready and the Ready marker has been printed.
        """
        pass

    def on_platform_shutdown(self):
        """
        Called when LocalEmu is shutting down. Can be used to close any resources (threads, processes, sockets, etc.).
        """
        pass

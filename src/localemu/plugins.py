...
from localemu.utils.files import rm_rf
from localemu.utils.ssl import get_cert_pem_file_path
...
def deprecation_warnings() -> None:
    ...
    from localemu.deprecations import log_deprecation_warnings
...
class OASPlugin(Plugin):
    ...
    namespace = "localemu.openapi.spec"

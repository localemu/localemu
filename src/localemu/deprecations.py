...
#
# Please make sure this is in-sync with https://localemu.cloud/docs/configuration
#
DEPRECATIONS = [
    ...
    EnvVarDeprecation(
        "USE_SINGLE_REGION",
        "0.12.7",
        "LocalEmu now has full multi-region support. This option has no effect. Please remove it from your configuration.",  # noqa
    ),
    # Deprecated in 0.12.7, removed in 3.0.0
    EnvVarDeprecation(
        "DEFAULT_REGION",
    ...
    EnvVarDeprecation(
        "DATA_DIR",
        "1.0.0",
        "Please use PERSISTENCE instead. The state will be stored in your LocalEmu volume in the state/ directory.",
    ),
    EnvVarDeprecation(
        "HOST_TMP_FOLDER",
        "1.0.0",
    ...
    EnvVarDeprecation(
        ...
        "1.0.0",
        "The legacy single-file persistence mechanism is not supported anymore. "
        "Set PERSISTENCE=1 to enable LocalEmu's per-service state persistence instead.",
    ),
    ...
    # Since 2.0.0 - HOSTNAME_EXTERNAL will be replaced with LOCALEMU_HOST
    EnvVarDeprecation(
        "HOSTNAME_EXTERNAL",
        "2.0.0",
        "This configuration will be migrated to LOCALEMU_HOST",
    ),
    # Since 2.0.0 - LOCALEMU_HOST will be replaced with LOCALEMU_HOST
    EnvVarDeprecation(
        "LOCALEMU_HOSTNAME",
        "2.0.0",
        "This configuration will be migrated to LOCALEMU_HOST",
    ...
    EnvVarDeprecation(
        ...
        "Please mount the Docker socket /var/run/docker.sock as a volume when starting LocalEmu.",
    ),
    EnvVarDeprecation(
    ...
    EnvVarDeprecation(
        "SQS_PORT_EXTERNAL",
        "1.0.0",
        "This option has no effect anymore. Please use LOCALEMU_HOST instead.",
    ),
    EnvVarDeprecation(
    ...
    EnvVarDeprecation(
        "PERSIST_ALL",
        "2.3.2",
        "LocalEmu treats backends and assets the same with respect to persistence. Please remove PERSIST_ALL.",
    ),
    EnvVarDeprecation(
        "LAMBDA_EVENTS_INTERNAL_SQS",
        "4.0.0",
        "This option is ignored because the LocalEmu SQS dependency for event invokes has been removed since 4.0.0"
    ...
    EnvVarDeprecation(
        ...
        "By default this is the LocalEmu Lambda endpoint. Use default to select the original AWS Lambda endpoint.",
    ),
    EnvVarDeprecation(
        ...
        "By default, LocalEmu routes Step Functions traffic to its internal runtime. "
...
def log_env_warning(deprecations: list[EnvVarDeprecation]) -> None:
    ...
    if deprecations:
        ...
        for deprecation in deprecations:
            LOG.warning(
                "%s is deprecated (since %s) and will be removed in upcoming releases of LocalEmu! %s",
                deprecation.env_var,
...
def deprecated_endpoint(
    ...
    :param deprecation_version: version of LocalEmu with which this endpoint is deprecated
    ...
    def deprecated_wrapper(*args, **kwargs):
        LOG.warning(
            "%s is deprecated (since %s) and will be removed in upcoming releases of LocalEmu! Use %s instead.",
            previous_path,
            deprecation_version,
            new_path,
        )

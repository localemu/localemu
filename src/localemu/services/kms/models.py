...
from localemu.services.kms.utils import is_valid_key_arn
from localemu.services.stores import AccountRegionBundle, BaseStore, LocalAttribute
from localemu.utils.aws.arns import get_partition, kms_alias_arn, kms_key_arn
from localemu.utils.crypto import decrypt, encrypt
...
class KmsCryptoKey:
    ...
    def __init__(self, key_spec: str, key_material: bytes | None = None):
        ...
        # But LocalEmu uses symmetric encryption with this key_material even for other specs. Asymmetric keys are
...
class KmsKey:
    ...
    def schedule_key_deletion(self, pending_window_in_days: int) -> None:
        ...
        #  notion of a primary key in LocalEmu. Might be useful to improve it.

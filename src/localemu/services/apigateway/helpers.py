...
def localemu_path_based_url(api_id: str, stage_name: str, path: str) -> str:
...
def get_regional_domain_name(domain_name: str, region_name: str) -> str:
    ...
    In LocalEmu, we're returning this format: "d-<domain_hash>.execute-api.localhost"
    """
    domain_name_hash = get_domain_name_hash(domain_name, region_name)
    host = localemu_host().host

...
from localemu.constants import HEADER_LOCALEMU_EDGE_URL
...
from localemu.services.apigateway.legacy.helpers import get_api_account_id_and_region
from localemu.services.apigateway.legacy.invocations import invoke_rest_api_from_request
from localemu.utils.aws.aws_responses import LambdaResponse
from localemu.utils.strings import remove_leading_extra_slashes
...
def to_invocation_context(
    ...
    # set the x-localemu-edge header, it is used to parse the domain
    headers[HEADER_LOCALEMU_EDGE_URL] = request.host_url.strip("/")
...
class ApigatewayRouter:
    ...
    def register_routes(self) -> None:
        ...
        # add the localemu-specific _user_request_ routes
        self.router.add(

...
from localemu.constants import APPLICATION_JSON, HEADER_CONTENT_TYPE
from localemu.services.apigateway.legacy.context import ApiInvocationContext
from localemu.services.apigateway.legacy.helpers import (
...
from localemu.services.apigateway.legacy.templates import (
    MappingTemplates,
    RequestTemplates,
    ResponseTemplates,
)
from localemu.services.stepfunctions.stepfunctions_utils import await_sfn_execution_result
from localemu.utils import common
from localemu.utils.aws.arns import ARN_PARTITION_REGEX, extract_region_from_arn, get_partition
from localemu.utils.aws.aws_responses import (
    LambdaResponse,
...
from localemu.utils.aws.templating import VtlTemplate
from localemu.utils.collections import dict_multi_values, remove_attributes
from localemu.utils.common import make_http_request, to_str
from localemu.utils.http import add_query_params_to_url, canonicalize_headers, parse_request_data
from localemu.utils.json import json_safe, try_json
from localemu.utils.strings import camel_to_snake_case, to_bytes
...
def get_service_factory(region_name: str, role_arn: str):
    if role_arn:
        # Do not cache assumed-role sessions: their temporary credentials expire,
        # so caching them indefinitely would cause stale credential errors.
...
def _get_internal_mocked_headers_cached(
    service_name: str,
    region_name: str,
    source_arn: str,
    role_arn: str | None,
...
def get_internal_mocked_headers(
    ...
    """Return a copy of cached headers to prevent callers from mutating the cache."""
    return _get_internal_mocked_headers_cached(

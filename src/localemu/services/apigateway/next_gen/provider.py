...
from localemu.services.apigateway.legacy.provider import (
    STAGE_UPDATE_PATHS,
    ApigatewayProvider,
...
class ApigatewayNextGenProvider(ApigatewayProvider):
    ...
    def create_stage(self, context: RequestContext, request: CreateStageRequest) -> Stage:
        # TODO: we need to internalize Stages and Deployments in LocalEmu, we have a lot of split logic
    ...
    def create_deployment(
        ...
        **kwargs,
        ...
        frozen_deployment = freeze_rest_api(
            ...
            localemu_rest_api=rest_api_container,
        )

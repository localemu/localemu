...
from localemu.aws.api.apigateway import Resource
from localemu.aws.protocol.routing import (
    path_param_regex,
...
from localemu.services.apigateway.models import RestApiDeployment

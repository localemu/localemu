...
from localemu.constants import APPLICATION_JSON, INTERNAL_AWS_ACCESS_KEY_ID
...
def _get_internal_mocked_headers_cached(
    ...
    # TODO: maybe use the localemu.utils.aws.client.SigningHttpClient instead of directly mocking the Authorization

...
from localemu.services.apigateway.helpers import apply_json_patch_safe
from localemu.utils.common import str_to_bool
...
def apply_patches():
    ...
    def create_rest_api(fn, self, *args, tags=None, **kwargs):
        """
        https://github.com/localemu/localemu/pull/4413/files

...
from localemu.services.cloudformation.engine import template_preparer
from localemu.services.cloudformation.engine.parameters import resolve_ssm_parameter
from localemu.services.cloudformation.engine.transformers import FailedTransformationException
from localemu.services.cloudformation.engine.v2.change_set_model import (
    ChangeSetModel,
    ChangeType,
    UpdateModel,
)
from localemu.services.cloudformation.engine.v2.change_set_model_describer import (
    ChangeSetModelDescriber,
)
from localemu.services.cloudformation.engine.v2.change_set_model_executor import (
    ChangeSetModelExecutor,
)
from localemu.services.cloudformation.engine.v2.change_set_model_transform import (
    ChangeSetModelTransform,
)
from localemu.services.cloudformation.engine.v2.change_set_model_validator import (
...
from localemu.services.cloudformation.provider import (
    ARN_CHANGESET_REGEX,
    ARN_STACK_REGEX,
    ARN_STACK_SET_REGEX,
...
from localemu.services.cloudformation.v2.entities import (
    ChangeSet,
    Stack,
    StackInstance,
    StackSet,
)
from localemu.services.cloudformation.v2.types import EngineParameter, engine_parameter_value
from localemu.services.plugins import ServiceLifecycleHook
from localemu.utils.collections import select_attributes
...
class CloudformationProviderV2(CloudformationProvider, ServiceLifecycleHook):
    ...
    def _log_create_issue_info(self):
        base = "https://github.com/localemu/localemu/issues/new"
        query_args = {

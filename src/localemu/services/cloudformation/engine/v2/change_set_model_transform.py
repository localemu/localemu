...
from localemu.services.cloudformation.engine.policy_loader import create_policy_loader
from localemu.services.cloudformation.engine.template_preparer import parse_template
...
from localemu.services.cloudformation.stores import get_cloudformation_store
from localemu.services.cloudformation.v2.entities import ChangeSet
...
class ChangeSetModelTransform(ChangeSetModelPreproc):
    ...
    def _apply_global_serverless_transformation(
        region_name: str, template: dict, parameters: dict, account_id: str | None = None
    ) -> dict:
        ...
        loader = create_policy_loader(account_id=account_id, region_name=region_name)

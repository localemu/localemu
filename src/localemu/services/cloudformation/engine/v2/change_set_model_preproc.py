...
from localemu.aws.api.cloudformation import ResourceStatus
from localemu.aws.api.ec2 import AvailabilityZoneList, DescribeAvailabilityZonesResult
...
from localemu.services.cloudformation.engine.v2.resolving import (
    REGEX_DYNAMIC_REF,
...
from localemu.services.cloudformation.v2.types import ResolvedResource
from localemu.utils.aws.arns import get_partition
from localemu.utils.numbers import to_number
from localemu.utils.objects import get_value_from_path
...
_AWS_URL_SUFFIX = localemu_host().host  # The value in AWS is "amazonaws.com"

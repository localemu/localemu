...
from localemu.aws.api.cloudformation import ChangeAction
from localemu.services.cloudformation.resource_provider import ResourceProviderExecutor
from localemu.services.cloudformation.v2.types import (
    EngineParameter,
...
class NothingType:
    ...
    PERF-R2-05: thread-safe singleton via double-checked locking so concurrent
    first-time instantiations cannot observe two distinct sentinel instances.
    """

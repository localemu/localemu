...
from localemu.services.cloudformation.engine.template_deployer import resolve_refs_recursively
...
def apply_serverless_transformation(
    ...
    with _sam_env_lock:
        ...
        simplified_parameters = {
            k: v.get("ResolvedValue") or v["ParameterValue"]
        ...
        try:
            ...
            raise FailedTransformationException(
                transformation=SERVERLESS_TRANSFORM, message=str(e)
            )
        finally:

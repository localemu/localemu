...
from localemu.aws.api.cloudformation import Capability, ChangeSetType, Parameter
from localemu.services.cloudformation.engine.parameters import (
    StackParameter,
...
from localemu.utils.id_generator import (
    ExistingIds,
    ResourceIdentifier,
    Tags,
    generate_short_uid,
...
from localemu.utils.objects import recurse_object
...
class Stack:
    ...
    def __init__(
        ...
        # Per-stack lock for thread-safe state mutations during concurrent operations
...
# KNOWN TECHNICAL DEBT (CF-35): StackChangeSet inherits from Stack, which
# creates tight coupling and makes the change set carry unnecessary stack state.
# A proper fix would extract a shared base or use composition, but this is a
# significant refactor with wide-reaching implications across both V1 and V2 engines.
# TODO: refactor to composition when the V1 engine is retired.

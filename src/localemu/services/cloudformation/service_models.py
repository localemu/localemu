...
from localemu.services.cloudformation.deployment_utils import check_not_found_exception
...
class GenericBaseModel:
    """Abstract base class representing a resource model class in LocalEmu.

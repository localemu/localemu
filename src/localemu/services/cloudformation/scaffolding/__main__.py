...
class FileWriter:
    ...
    def __init__(
        ...
        # Path inside the repo where generated provider files land. The
        # earlier LocalStack-pro branch is gone in LocalEmu (everything
        # is free + open), so the path is always the community one.

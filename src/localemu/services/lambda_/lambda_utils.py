...
HINT_LOG = logging.getLogger("localemu.services.lambda_.hints")
...
def get_handler_file_from_name(handler_name: str, runtime: str = None):
    ...
    # a CloudFormation model in localemu.services.cloudformation.models.lambda_.LambdaFunction.get_lambda_code_param
    runtime = runtime or Runtime.python3_12

    # TODO: consider using localemu/testing/aws/lambda_utils.py:RUNTIMES_AGGREGATED for testing or moving the constant
    #   RUNTIMES_AGGREGATED to LocalEmu core if this helper remains relevant within CloudFormation.

...
from localemu.services.lambda_.invocation.lambda_models import FunctionVersion, InvocationResult
from localemu.services.lambda_.invocation.plugins import RuntimeExecutorPlugin
...
class RuntimeExecutor(ABC):
    ...
    def get_address(self) -> str:
        """
        Get the address the runtime executor is available at for the LocalEmu container.
    ...
    def get_endpoint_from_executor(self) -> str:
        """
        Get the address of LocalEmu the runtime execution environment can communicate with LocalEmu

        :return: IP address or hostname of LocalEmu (from the view of the execution environment)
        """
        pass
    ...
    def get_runtime_endpoint(self) -> str:
        ...
        :return: Base url of the callback, e.g. "http://123.123.123.123:4566/_localemu_lambda/ID1234" without trailing slash
        """
        pass
    ...
    def invoke(
        ...
        :param function_timeout: The function's configured timeout in seconds
        """
        pass

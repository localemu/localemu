...
from localemu.services.lambda_.event_source_mapping.esm_event_processor import (
    EsmEventProcessor,
)
from localemu.services.lambda_.event_source_mapping.esm_worker import EsmStateReason, EsmWorker
from localemu.services.lambda_.event_source_mapping.pipe_loggers.noops_pipe_logger import (
    NoOpsPipeLogger,
)
...
from localemu.services.lambda_.event_source_mapping.pollers.dynamodb_poller import DynamoDBPoller
from localemu.services.lambda_.event_source_mapping.pollers.kinesis_poller import KinesisPoller
from localemu.services.lambda_.event_source_mapping.pollers.poller import Poller
from localemu.services.lambda_.event_source_mapping.pollers.sqs_poller import (
    DEFAULT_MAX_WAIT_TIME_SECONDS,
    SqsPoller,
)
from localemu.services.lambda_.event_source_mapping.senders.lambda_sender import LambdaSender
...
class EsmWorkerFactory:
    ...
    def get_esm_worker(self) -> EsmWorker:
        ...
        if ldm.IS_LDM_ENABLED:
            ...
            # Maximum Lambda function execution time plus buffer for container overhead
            timeout_seconds = LAMBDA_MAX_TIMEOUT_SECONDS + 5

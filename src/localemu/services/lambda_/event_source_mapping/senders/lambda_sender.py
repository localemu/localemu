...
from localemu.aws.api.pipes import PipeTargetInvocationType
from localemu.services.lambda_.api_utils import function_locators_from_arn
from localemu.services.lambda_.event_source_mapping.pipe_utils import to_json_str
from localemu.services.lambda_.event_source_mapping.pollers.poller import has_batch_item_failures
from localemu.services.lambda_.event_source_mapping.senders.sender import (
...
class LambdaSender(Sender):
    ...
    def send_events(self, events: list[dict] | dict) -> dict:
        ...
        #  localemu.services.lambda_.event_source_listeners.adapters.EventSourceAsfAdapter.invoke_with_statuscode

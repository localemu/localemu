...
from localemu.utils.json import BytesEncoder
...
def to_json_str(obj: any) -> str:
    ...
    JSON encoders in LocalEmu:
    * localemu.utils.json.CustomEncoder
    * localemu.utils.json.BytesEncoder
    * localemu.services.events.utils.EventJSONEncoder
    * localemu.services.stepfunctions.asl.utils.encoding._DateTimeEncoder
    """

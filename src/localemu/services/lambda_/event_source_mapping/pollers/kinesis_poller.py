...
from localemu.aws.api.kinesis import StreamStatus
...
class KinesisPoller(StreamPoller):
    ...
    def transform_into_events(self, records: list[dict], shard_id) -> list[dict]:
        ...
        for record in records:
            ...
            #  localemu.services.lambda_.event_source_listeners.kinesis_event_source_listener.KinesisEventSourceListener._create_lambda_event_payload

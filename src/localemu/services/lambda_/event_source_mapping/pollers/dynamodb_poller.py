...
from localemu.services.lambda_.event_source_mapping.pipe_utils import get_current_time
from localemu.services.lambda_.event_source_mapping.pollers.stream_poller import StreamPoller
...
class DynamoDBPoller(StreamPoller):
    ...
    def transform_into_events(self, records: list[dict], shard_id) -> list[dict]:
        ...
        for record in records:
            ...
            #  localemu.services.lambda_.event_source_listeners.dynamodb_event_source_listener.DynamoDBEventSourceListener._create_lambda_event_payload

...
from localemu.services.stepfunctions.asl.component.state.state_choice.comparison.operator.implementations.is_operator import (
    IsTimestamp,
)
...
from localemu.services.stepfunctions.asl.utils.json_path import extract_json

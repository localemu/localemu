...
from localemu.aws.api.sqs import QueueAttributeName
...
HEADER_LOCALEMU_SQS_OVERRIDE_MESSAGE_COUNT = "x-localemu-sqs-override-message-count"
HEADER_LOCALEMU_SQS_OVERRIDE_WAIT_TIME_SECONDS = "x-localemu-sqs-override-wait-time-seconds"

from localemu.aws.api.s3 import InvalidTag
from localemu.aws.api.s3control import Tag, TagList
...
from localemu.services.s3.utils import TAG_REGEX
from localemu.services.s3control.exceptions import NoSuchResource
...
def validate_arn_for_tagging(
    ...
    if not resource_arn.startswith(s3_prefix):
        ...
        raise NotImplementedAvoidFallbackError(
            "LocalEmu only support Bucket tagging operations for S3Control"
        )

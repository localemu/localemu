...
from localemu.services.s3.exceptions import InvalidRequest, MalformedACLError, MalformedXML
...
def validate_lifecycle_configuration(lifecycle_conf: BucketLifecycleConfiguration) -> None:
    ...
    :return: None
    """
    # Expiration is handled by the background lifecycle worker (lifecycle.py)
    # Transition is not yet supported

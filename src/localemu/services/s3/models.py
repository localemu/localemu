...
from localemu.services.s3.exceptions import InvalidRequest
from localemu.services.s3.headers import replace_non_iso_8859_1_characters
...
class S3Bucket:
    ...
    def __init__(
        ...
        self.object_lock_default_retention = None

...
from localemu.aws.connect import InternalRequestParameters
...
class RequestContext(RoloRequestContext):
    """
    A RequestContext object holds the information of an HTTP request that is processed by the LocalEmu Gateway. The
    ...
    """Data sent by client-side LocalEmu during internal calls."""

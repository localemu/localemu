...
from localemu.config import EXTRA_CORS_ALLOWED_HEADERS, EXTRA_CORS_EXPOSE_HEADERS
from localemu.constants import LOCALHOST, LOCALHOST_HOSTNAME, PATH_USER_REQUEST
...
def _get_allowed_cors_internal_domains() -> set[str]:
    ...
    """
    return {LOCALHOST, LOCALHOST_HOSTNAME, localemu_host().host}
...
def _get_allowed_cors_origins() -> list[str]:
    ...
    result = [
        ...
        "https://app.localemu.cloud",
        "http://app.localemu.cloud",
        "https://localhost",
        "https://localhost",

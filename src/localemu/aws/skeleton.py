...
from localemu.aws.api.core import ServiceRequest, ServiceRequestHandler, ServiceResponse
from localemu.aws.protocol.parser import create_parser
from localemu.aws.protocol.serializer import ResponseSerializer, create_serializer
...
class Skeleton:
    ...
    def on_not_implemented_error(
        ...
        if exception_message is not None:
            ...
            message = (
                f"API for service '{service_name}' has not yet been implemented in LocalEmu. "
                f"Please open an issue at https://github.com/localemu/localemu/issues."
            )

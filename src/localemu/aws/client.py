...
from localemu.utils.patch import Patch, patch
...
def _patch_botocore_json_parser():
    ...
    def _parse_body_as_json(fn, self, body_contents):
        ...
        try:
            ...
            from localemu.aws.protocol._cbor import loads
...
class GatewayShortCircuit:
    ...
    def __call__(
        ...
        # TODO: in some flows we override endpoint_url to target an internal backend directly
        ...
        # this is using the same services as `localemu.aws.protocol.service_router.resolve_conflicts`, maybe

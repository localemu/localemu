...
from localemu.utils.xml import strip_xmlns
...
class BaseCBORResponseSerializer(ResponseSerializer):
    ...
    LocalEmu defines a way to have user-defined exception by subclassing `CommonServiceException`, so it needs to be
...
class SqsJsonResponseSerializer(JSONResponseSerializer):
    ...
    #  LocalEmu: "InvalidParameterValue"
...
def aws_response_serializer(
    ...
    This can be used to create AWS request handlers in a convenient way. Example usage::
        ...
        from localemu.http import route, Request
